                ...
                foreach (var temp_rc in TestDBData.RedRatGetRCNameList())
                {
                    ...
                    if (TestDBData.Signal_Type_Supported == true)
                    {
                        ...
                        if ((TestDBData.RedRatSelectedSignalType() == (typeof(DoubleSignal))) || (TestDBData.RC_ToggleData_Length_Value() > 0))
                        {
                            ...
                            // Use UART to transmit RC signal
                            rc_duration = TestBlueRat.SendOneRC(TestDBData) / 1000 + 1;
        ...
        private void Test_I2C_Write_Word(BlueRat my_blue_rat)
        {
            ...
            // value going down
            {
                ...
                do
                {
                    ...
                    bRet = my_blue_rat.Set_I2C_Output_SlaveAdr_Word((0x70 << 1), 0x0E00);
                    bRet = my_blue_rat.Set_I2C_Output_SlaveAdr_Word((0x70 << 1), 0x0F00);
                    bRet = my_blue_rat.Set_I2C_Output_SlaveAdr_Word((0x70 << 1), 0x1055);
                    bRet = my_blue_rat.Set_I2C_Output_SlaveAdr_Word((0x70 << 1), 0x11aa);
